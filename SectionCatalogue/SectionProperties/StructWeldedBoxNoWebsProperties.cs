...
{
    public class StructWeldedBoxNoWebsProperties : SectionBase
    {
        public double h;
        public double b;
        public double tw;
        ...
        public StructWeldedBoxNoWebsProperties(double depth, double width, double webThick, double FlangeThick, double outstandLength, double weldLeg, string denom)
        {
            ...
            this.A = 2.0 * this.h * this.tw;
            this.Iyy = 2.0 * (this.tw * Math.Pow(this.h, 3.0) / 12.0);
            this.Welyy = this.Iyy / (this.h / 2.0);
            this.Wplyy = Math.Pow(this.h, 2.0) * this.tw / 2.0;
            this.iy = Math.Sqrt(this.Iyy / this.A);
            this.Izz = 2.0 * (this.h * Math.Pow(this.tw, 3.0) / 12.0 + this.h * this.tw * Math.Pow(this.b / 2.0 - this.tw / 2.0, 2.0));
            this.Welzz = this.Izz / (this.b / 2.0);
            this.Wplzz = 2.0 * (this.h * this.tw * (this.b / 2.0 - this.tw / 2.0));
